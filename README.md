...
*   `--list-replacements` (`--list-rep`, `--list-rules`): Show active text search-and-replace rules from configuration and command-line arguments and exit. Use `--json` for machine-readable output.
