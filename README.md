...
*   `--list-ignores` (`--list-ig`): Show active ignore patterns from loaded ignore files and exit. Supports optional `QUERY` filtering and `--json` for machine-readable output.
