...
*   `--replace-line PATTERN REPLACEMENT`: Add a line-based search-and-replace rule using regular expressions. Matching lines that follow each other collapse into one replacement.
