...
def _print_execution_summary(stats, args, pairing_enabled, destination_desc=None, duration=None, source_desc=None):
    ...
    if stats['files_by_extension']:
        ...
        for d in display_items:
            ...
            row_end = f"  {C_BOLD}{C_CYAN}{count:7,}{C_RESET}  {C_BOLD}{C_CYAN}{f_percent:>6.1f}%{C_RESET}  {C_BOLD}{d['ext']}{C_RESET}"

            print(f"    {row_metrics}{C_BOLD}{C_CYAN}{w_percent:>5.1f}%{C_RESET}  {C_DIM}[{C_RESET}{bar}{C_DIM}]{C_RESET}{row_end}", file=sys.stderr)
