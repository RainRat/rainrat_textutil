...
def test_format_metadata_summary_both_present():
...
def test_format_metadata_summary_only_status():
    meta = {'status': 'A'}
    result = _format_metadata_summary(meta)
    assert result == " [A]"

def test_format_metadata_summary_only_summary():
    meta = {'files': 1}
    result = _format_metadata_summary(meta)
...
def test_format_metadata_summary_pluralization():
...
def test_format_metadata_summary_singular():
...
def test_format_metadata_summary_tokens_none_or_zero():
    meta = {'tokens': None}
    result = _format_metadata_summary(meta)
...
def test_format_metadata_summary_lines_zero():
    meta = {'lines': 0}
    result = _format_metadata_summary(meta)
